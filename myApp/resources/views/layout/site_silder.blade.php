    ...
    <div class="container-fluid side-bar-container">
        ...
        <ul class="side a-collapse short">
            <a class="ul-text"><i class="fa fa-users" aria-hidden="true"></i> Customers
                ...
                <i class="fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All Customers</a>
                </li>
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Add Customer</a></li>
            </div>
        </ul>
        ...
        <ul class="side a-collapse short">
            ...
            <div class="side-item-container">
                ...
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Add Invoice</a></li>
            </div>
        </ul>
        ...
        <ul class="side a-collapse short">
            <a class="ul-text"><i class="fab fa-slideshare mr-1"></i> Gold Transactions
                ...
                <i class="fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All Gold
                        Transactions</a>
                </li>
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Add
                        Transaction</a></li>
            </div>
        </ul>
        ...
        <ul class="side a-collapse short">
            ...
            <div class="side-item-container hide animated">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Create Employee</a>
                </li>
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All
                        Users</a></li>
        ...
        <ul class="side a-collapse short">
            <a class="ul-text"><i class="fas fa-users-cog mr-1"></i> Products
                ...
                <i class="fas fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container hide animated">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Create Product</a>
                </li>
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All
                        Product</a></li>
            </div>
        ...
        <ul class="side a-collapse short">
            <a class="ul-text"><i class="fab fa-slideshare mr-1"></i> Order
                ...
                <i class="fas fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container hide animated">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All Order</a>
                </li>
                <li class="side-item">
                    <a href="">
        ...
        <ul class="side a-collapse short">
            <a class="ul-text"><i class="fas fa-users-cog mr-1"></i> User Management
                ...
                <i class="fas fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container hide animated">
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>Create New User</a>
                </li>
                <li class="side-item"><a href=""><i class="fas fa-angle-right mr-2"></i>All
                        Users</a></li>
